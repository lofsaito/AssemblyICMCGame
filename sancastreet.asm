...
winscreen:
	...
	loadn r0, #161
	loadn r1, #winstring0 ; endereco da primeira linha da tela
	loadn r2, #0 ;cor do mapa
	call Imprimestr ;imprime a tela inicial
	
	loadn r0, #241
	loadn r1, #winstring1 ; endereco da primeira linha da tela
	loadn r2, #0 ;cor do mapa
	call Imprimestr ;imprime a tela inicial
	...
	winscreenLoop:
		loadn r0, #323
		loadn r1, #winstring2 ; endereco da primeira linha da tela
		loadn r2, #0 ;cor do mapa
		call Imprimestr ;imprime a tela inicial
		add r0, r0, r3
		loadn r1, #winstring3 ; endereco da primeira linha da tela
		loadn r2, #0 ;cor do mapa
		call Imprimestr ;imprime a tela inicial
		add r0, r0, r3
		loadn r1, #winstring4 ; endereco da primeira linha da tela
		loadn r2, #0 ;cor do mapa
		call Imprimestr ;imprime a tela inicial
		...
		loadn r0, #323
		loadn r1, #winstring5 ; endereco da primeira linha da tela
		loadn r2, #0 ;cor do mapa
		call Imprimestr ;imprime a tela inicial
		add r0, r0, r3
		loadn r1, #winstring6 ; endereco da primeira linha da tela
		loadn r2, #0 ;cor do mapa
		call Imprimestr ;imprime a tela inicial
		add r0, r0, r3
		loadn r1, #winstring7 ; endereco da primeira linha da tela
		loadn r2, #0 ;cor do mapa
		call Imprimestr ;imprime a tela inicial
		call delay
	jmp winscreenLoop
...
imprimescore:
	...
	loadn r1, #scorestring
	loadn r0, #42 ;posicao da tela
	loadn r2, #0 ;cor da msg
	call Imprimestr
...
Printnr:	; Imprime um numero menor que 1000 com todas as casas: Parametors: r0 - numero; r3 - posicao na tela
	push r0
	push r1
	push r2
	push r3
...
pausar:
	...
	loadn r0, #' '
	loadn r1, #pause
	loadn r0, #81 ;posicao da tela para escrever a msg de pausado
	loadn r2, #768 ;cor da msg
	call Imprimestr
	loadn r1, #'p'
	pausarLoop:
		inchar r0
...
;funcao para explodir o carrinho quando ele tromba
explosion:
	push r0
	push r1
	push r2
...
;funcao para fazer o carrinho pegar fogo apos a explosao	
fireexplosion:
	push r0
	push r1
	push r2
...
;funcao da tela de customizacao do carrinho	
carCustomize:
	push r0
	push r1
	push r2
...
;funcao para veriicar se existe colisao do carrinho com objetos na estrada	
colisao:
	push r0
	push r1
	push r2
...
winstring0: string "    Incrivel voce conseguiu desviar   "
winstring1: string "    de todos os buracos da cidade!!   "

winstring2: string "           |O|   |O|   |O|          "
winstring3: string "            #     #     #           "
winstring4: string "           | |   | |   | |          "

winstring5: string "            O     O     O           "
winstring6: string "          --#-- --#-- --#--         "
winstring7: string "           | |   | |   | |          "
